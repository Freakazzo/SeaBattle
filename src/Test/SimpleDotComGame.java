...
public class SimpleDotComGame {
    public static void main(String[] args) {
        ...
        GameHelper2 helper = new GameHelper2();//Это спец. класс, который содержит метод для приёма пользовательского ввода.
                                            // Пока сделаем вид, что это часть Java
        SimpleDotCom theDotCom = new SimpleDotCom();// Создаём объект "Сайт"
